...
def build_graph(site_dropdown):
    if site_dropdown == 'ALL':
        pie = px.pie(data_frame = spacex_df, names='Launch Site', values='class' ,title='Total Launches By Sites')
        return pie
    else:
        spec_df=spacex_df.loc[spacex_df['Launch Site'] == site_dropdown]
        pie = px.pie(data_frame = spec_df, names='class',title='Total Success Launchs for site {}'.format(site_dropdown))
        return pie
